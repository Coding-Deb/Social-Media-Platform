...
import MyPostScreen from './SRC/Screens/MainScreen/Post/MyPostScreen';
import MainChatScreen from './SRC/Screens/MainScreen/Chat/MainChatScreen';
    ...
    <Statedata>
      <NavigationContainer>
        <Stack.Navigator screenOptions={{ headerShown: false }} initialRouteName='Splash'>
          ...
          <Stack.Screen name='MainChat' component={MainChatScreen} options={{ animation: 'slide_from_right' }} />
          ...
          <Stack.Screen name='MyPost' component={MyPostScreen} options={{ animation: 'slide_from_bottom' }} />
